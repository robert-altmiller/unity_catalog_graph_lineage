...
- In the Databricks notebook section __'Create and Show Lineage Graph With Nodes and Edges'__ update the following section below in red, and use the __ 'Build Graph Examples'__ below to understand the different ways to set __data_level__ and __graph_level__.
